...
STEP_SIZE:  int = 16 # Stimulation stepsize used in PSF
...
# INPUT_SIZE: List = [1, 28, 28] # Input images' shape (default to be MNIST) # TODO
INPUT_SIZE: List = [3, 224, 224] # Input images' shape (default to be MNIST) # TODO
