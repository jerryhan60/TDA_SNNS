...
class ModelData:
    def __init__(self,
        ...
        # handle loading from just the model weights
        if not initialize_from_cache:
            self.model_folder_path = base_paths.model_folder_path
            self.data_folder_path = base_paths.data_folder_path
            self.troj_config = base_paths.troj_config
            self.handle_load_model_from_weights()
        else:
            # handle loading from post-featurization cache
            self.handle_load_model_from_cache()
    ...
    def handle_load_model_from_weights(self):
    ...
    def handle_load_model_from_cache(self):
        pass
